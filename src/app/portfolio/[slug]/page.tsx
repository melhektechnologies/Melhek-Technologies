    ...
    <MarketingLayout>
      <main className="relative bg-melhek-dark overflow-x-hidden pt-36 pb-24">
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="relative rounded-[2rem] border border-white/10 overflow-hidden bg-melhek-dark mb-12 shadow-[0_24px_80px_-20px_rgba(127,169,255,0.15)]">
            {/* Browser top bar */}
            <div className="h-10 bg-black/60 backdrop-blur-sm border-b border-white/5 flex items-center px-6 gap-2 relative z-10">
            ...
            {/* Viewport content */}
            <div className="relative aspect-[16/9] w-full overflow-hidden bg-melhek-navy flex items-center justify-center">
              {project.image ? (
                <Image
                  src={project.image}
