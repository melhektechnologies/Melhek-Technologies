                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {sectorProjects.map((project) => (
                      <Link
                        ...
                        className="group glass rounded-[2rem] border-white/5 hover:border-melhek-blue/30 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col justify-between h-full overflow-hidden"
                      >
